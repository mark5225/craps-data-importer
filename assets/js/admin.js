jQuery(document).ready(function($) {
    ...
    console.log('CDI Admin JS loaded');
...
var CDI = {
    ...
    initializeComponents: function() {
        ...
        if (typeof cdiAjax === 'undefined') {
            ...
            console.log('cdiAjax object found:', cdiAjax);
        }
    },
    ...
    handleFileUpload: function(form) {
        ...
        if (typeof cdiAjax !== 'undefined' && cdiAjax.nonce) {
            formData.append('nonce', cdiAjax.nonce);
            console.log('Nonce added:', cdiAjax.nonce);
        } else {
        ...
        $.ajax({
            url: cdiAjax.ajaxurl || '/wp-admin/admin-ajax.php',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
